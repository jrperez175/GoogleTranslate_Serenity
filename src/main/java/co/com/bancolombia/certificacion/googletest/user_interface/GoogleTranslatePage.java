...
private static TranslateExpression translateExpression;
	...
	public static final Target SOURCE_LANGUAGE_OPTION = Target.the("Source Language Option").locatedBy("//*[@id=\"gt-sl-gms-menu\"]/table/tbody/tr/td/div/div/div[contains(text(),'{0}')]");
	public static final Target TARGET_LANGUAGE_OPTION = Target.the("Target Language Option").locatedBy("//*[@id=\"gt-tl-gms-menu\"]/table/tbody/tr/td/div/div/div[contains(text(),'{0}')]");
