...
public class GoogleTranslatePage {
	...
	//public static final Target TARGET_LANGUAGE_OPTION_SPANISH = Target.the("Target Language Option Spanish").locatedBy("//*[@id=\"gt-tl-gms-menu\"]/table/tbody/tr/td/div/div/div[contains(text(),'Javan')]");
